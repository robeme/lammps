...
CommandStyle(temper/npt/atom/swap,TemperNPTAtomSwap)

#else

#ifndef LMP_TEMPERNPTATOMSWAP_H
#define LMP_TEMPERNPTATOMSWAP_H

#include "pointers.h"

namespace LAMMPS_NS {

class TemperNPTAtomSwap : protected Pointers {
 public:
  TemperNPTAtomSwap(class LAMMPS *);
  ~TemperNPTAtomSwap();
 ...
 private:
  ...
  int nptfix;                  // index of temperature fix to use
  int swpfix;                  // index of atom/swap fix to use
