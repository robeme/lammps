...
void WireDipole::compute_corr(double /*qsum*/, int eflag_atom, int eflag_global,
...
void WireDipole::matrix_corr(bigint *imat, double **matrix) {
  ...
  MPI_Allgatherv(&xprd_local.front(), ngrouplocal, MPI_DOUBLE,
                 &xprd_all.front(), &recvcounts.front(), &displs.front(),
                 MPI_DOUBLE, world);
  MPI_Allgatherv(&yprd_local.front(), ngrouplocal, MPI_DOUBLE,
                 &yprd_all.front(), &recvcounts.front(), &displs.front(),
                 MPI_DOUBLE, world);
